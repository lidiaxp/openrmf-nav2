...
# tmux send-keys -t $SESSION_NAME:7 "tmux kill-session -t $SESSION_NAME" C-m
...
# cp /root/rmf_ws/install/free_fleet_adapter/share/free_fleet_adapter/launch/fleet_adapter.launch.xml /root/rmf_ws/install/free_fleet_adapter/share/free_fleet_adapter/
...
# tmux new-window -t $SESSION_NAME -n zenoh_bridge
# echo "Starting Zenoh Bridge..."
# tmux send-keys -t $SESSION_NAME:2 "cd ~/rmf_ws/src && ./zenoh-bridge-ros2dds -c ~/rmf_ws/src/free_fleet/free_fleet_examples/config/zenoh/nav2_tb3_zenoh_bridge_ros2dds_client_config.json5" C-m
# sleep 2
...
# tmux new-window -t $SESSION_NAME -n fleet_adapter
# echo "Launching Free Fleet Nav2 Unique Multi TB3 Simulation Fleet Adapter..."
# tmux send-keys -t $SESSION_NAME:4 "export ROS_DOMAIN_ID=55 && ros2 launch free_fleet_examples nav2_tb3_simulation_fleet_adapter.launch.xml" C-m
# sleep 2
